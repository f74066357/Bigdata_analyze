...
allLat  = np.array(list(taxiDB1['Start_Lat'])+ list(taxiDB2['Start_Lat'])+ list(taxiDB3['Start_Lat']))
allLong = np.array(list(taxiDB1['Start_Lon'])+ list(taxiDB2['Start_Lon'])+ list(taxiDB3['Start_Lon']))
...
taxiDB1 = taxiDB1[(taxiDB1['Start_Lat']   >= latLimits[0] ) & (taxiDB1['Start_Lat']   <= latLimits[1]) ]
taxiDB1 = taxiDB1[(taxiDB1['Start_Lon']  >= longLimits[0]) & (taxiDB1['Start_Lon']  <= longLimits[1])]
taxiDB1 = taxiDB1.reset_index(drop=True)

taxiDB2 = taxiDB2[(taxiDB2['Start_Lat']   >= latLimits[0] ) & (taxiDB2['Start_Lat']   <= latLimits[1]) ]
taxiDB2 = taxiDB2[(taxiDB2['Start_Lon']  >= longLimits[0]) & (taxiDB2['Start_Lon']  <= longLimits[1])]
taxiDB2 = taxiDB2.reset_index(drop=True)

taxiDB3 = taxiDB3[(taxiDB3['Start_Lat']   >= latLimits[0] ) & (taxiDB3['Start_Lat']   <= latLimits[1]) ]
taxiDB3 = taxiDB3[(taxiDB3['Start_Lon']  >= longLimits[0]) & (taxiDB3['Start_Lon']  <= longLimits[1])]
